...
graph TD
  ...
  f_treatments_repository_ts["📄 treatments.repository.ts"]
  f_Root_repositories --> f_treatments_repository_ts
```

## 📄 FILE REGISTRY
| File Name | Type | Responsibility | Key Aliases Used |
|---|---|---|---|
| `treatments.repository.ts` | TypeScript | Provides core logic and orchestration for treatments.repository.ts. | @nestjs/common, @nestjs/mongoose |
