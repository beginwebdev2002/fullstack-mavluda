...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [treatments](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
graph TD
  subgraph schemas
    treatments_schema_ts["treatments.schema.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `treatments.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
