...
| `treatments.controller.ts` | File | Handles incoming HTTP requests and routing for treatments.controller.ts. | @nestjs/common, @nestjs/platform-express, @modules/treatments |
