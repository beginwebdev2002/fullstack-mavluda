[🏠 Home](../../../../../README.md) > [backend](../../../../README.md) > [src](../../../README.md) > [modules](../../README.md) > [treatments](../README.md) > [presentation](./README.md)
...
graph TD
  ...
  Root_presentation --> f_treatments_controller_ts
  f_dto["📁 dto"]
...
|---|---|---|---|
| `treatments.controller.ts` | NestJS Controller | Handles incoming HTTP requests Defines classes: TreatmentsController. | @nestjs |
