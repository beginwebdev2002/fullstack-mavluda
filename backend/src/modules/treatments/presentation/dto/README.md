...
graph TD
  Root_dto["📁 dto"]
  f_create_treatments_dto_ts["create-treatments.dto.ts"]
  Root_dto --> f_create_treatments_dto_ts
  f_update_treatments_dto_ts["update-treatments.dto.ts"]
  Root_dto --> f_update_treatments_dto_ts
```

### 📄 FILE REGISTRY
| File Name | Type | Responsibility | Key Aliases Used |
|---|---|---|---|
| `create-treatments.dto.ts` | TypeScript File | Defines classes: CreateServiceDto. | None |
| `update-treatments.dto.ts` | TypeScript File | Defines classes: UpdateServiceDto. | @nestjs |
