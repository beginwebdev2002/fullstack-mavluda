...
|---|---|---|---|
| `create-treatments.dto.ts` | TypeScript | Data Transfer Object definition and validation. | N/A |
| `update-treatments.dto.ts` | TypeScript | Data Transfer Object definition and validation. | @nestjs |
