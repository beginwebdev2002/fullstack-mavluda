...
|---|---|---|---|
| `create-treatments.dto.ts` | File | Provides core logic and orchestration for create-treatments.dto.ts. | N/A |
| `update-treatments.dto.ts` | File | Provides core logic and orchestration for update-treatments.dto.ts. | @nestjs/mapped-types |
