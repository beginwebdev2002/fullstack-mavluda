...
graph TD
  ...
  Root_treatments --> application["📁 application"]
  Root_treatments --> domain["📁 domain"]
  Root_treatments --> infrastructure["📁 infrastructure"]
  Root_treatments --> presentation["📁 presentation"]
