...
[backend](../../../../README.md) > [src](../../../README.md) > [modules](../../README.md) > [treatments](../README.md) > [domain](README.md)
...
graph TD
  subgraph domain
    treatments_entity_ts["treatments.entity.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `treatments.entity.ts` | Source | Handles source logic for Mavluda Beauty's luxury standards. | `None` |
