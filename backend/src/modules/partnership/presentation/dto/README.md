...
|---|---|---|---|
| `create-partnership.dto.ts` | TypeScript/JavaScript | Provides core logic and orchestration for create-partnership.dto.ts. | N/A |
| `update-partnership.dto.ts` | TypeScript/JavaScript | Provides core logic and orchestration for update-partnership.dto.ts. | @nestjs |
