...
graph TD
  ...
  f_Root_dto --> f_create_partnership_dto_ts
  f_update_partnership_dto_ts["📄 update-partnership.dto.ts"]
  f_Root_dto --> f_update_partnership_dto_ts
```
...
| `update-partnership.dto.ts` | TypeScript | Provides core logic and orchestration for update-partnership.dto.ts. | @nestjs/mapped-types |
