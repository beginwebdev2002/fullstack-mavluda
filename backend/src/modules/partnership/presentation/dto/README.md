...
|-----------|------|----------------|------------------|
| `create-partnership.dto.ts` | DTO | Data Transfer Object for input validation. | None |
| `update-partnership.dto.ts` | DTO | Data Transfer Object for input validation. | @nestjs/mapped-types |
