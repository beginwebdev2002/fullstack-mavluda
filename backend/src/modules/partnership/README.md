...
graph TD
  ...
  Root_partnership --> application["📁 application"]
  Root_partnership --> domain["📁 domain"]
  Root_partnership --> infrastructure["📁 infrastructure"]
  Root_partnership --> presentation["📁 presentation"]
