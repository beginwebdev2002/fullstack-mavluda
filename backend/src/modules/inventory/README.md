...
graph TD
  ...
  Root_inventory --> application["📁 application"]
  Root_inventory --> domain["📁 domain"]
  Root_inventory --> infrastructure["📁 infrastructure"]
  Root_inventory --> presentation["📁 presentation"]
