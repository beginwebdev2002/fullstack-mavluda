...
[backend](../../../../README.md) > [src](../../../README.md) > [modules](../../README.md) > [inventory](../README.md) > [domain](README.md)
...
graph TD
  subgraph domain
    inventory_entity_ts["inventory.entity.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `inventory.entity.ts` | Source | Handles source logic for Mavluda Beauty's luxury standards. | `None` |
