...
graph TD
  ...
  f_Root_presentation --> f_inventory_controller_ts
  f_Dir_dto["📁 dto"]
...
|---|---|---|---|
| `inventory.controller.ts` | TypeScript | Handles incoming HTTP requests and routing for inventory.controller.ts. | @nestjs/common |
