...
[backend](../../../../README.md) > [src](../../../README.md) > [modules](../../README.md) > [admin-settings](../README.md) > [domain](README.md)
...
graph TD
  subgraph domain
    admin_settings_entity_ts["admin-settings.entity.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `admin-settings.entity.ts` | Source | Handles source logic for Mavluda Beauty's luxury standards. | `None` |
