...
[Root](../../../../../../) > [backend](../../../../../) > [src](../../../../) > [modules](../../../) > [admin-settings](../../) > [infrastructure](../) > [schemas](./)
...
|---|---|---|---|
| `admin-settings.schema.ts` | TypeScript | Core logic and utilities for this domain. | @nestjs/mongoose |
