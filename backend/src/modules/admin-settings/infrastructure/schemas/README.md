...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [admin-settings](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
graph TD
  subgraph schemas
    admin_settings_schema_ts["admin-settings.schema.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `admin-settings.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
