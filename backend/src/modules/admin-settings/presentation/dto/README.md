...
|---|---|---|---|
| `create-admin-settings.dto.ts` | File | Provides core logic and orchestration for create-admin-settings.dto.ts. | N/A |
| `update-admin-settings.dto.ts` | File | Provides core logic and orchestration for update-admin-settings.dto.ts. | @nestjs/mapped-types |
