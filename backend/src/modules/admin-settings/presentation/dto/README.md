...
|-----------|------|----------------|------------------|
| `create-admin-settings.dto.ts` | DTO | Data Transfer Object for input validation. | None |
| `update-admin-settings.dto.ts` | DTO | Data Transfer Object for input validation. | @nestjs/mapped-types |
