...
graph TD
  ...
  f_user_schema_ts["📄 user.schema.ts"]
  f_Root_schemas --> f_user_schema_ts
```

## 📄 FILE REGISTRY
| File Name | Type | Responsibility | Key Aliases Used |
|---|---|---|---|
| `user.schema.ts` | TypeScript | Provides core logic and orchestration for user.schema.ts. | @nestjs/mongoose |
