...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [user](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
|-----------|------|----------------|------------------|
| `user.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
