...
## 🔗 Dependencies
- `../application/user.service`, `./dto/create-user.dto`, `./dto/update-user.dto`, `@common/interfaces/authenticated-request.interface`, `@modules/user`, `@nestjs/common`, `@nestjs/platform-express`, `multer`, `path`
