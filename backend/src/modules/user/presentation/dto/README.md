...
|---|---|---|---|
| `create-user.dto.ts` | TypeScript | Data Transfer Object definition and validation. | N/A |
| `update-user.dto.ts` | TypeScript | Data Transfer Object definition and validation. | @nestjs |
