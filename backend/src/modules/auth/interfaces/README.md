...
|---|---|---|---|
| `auth-response.interface.ts` | TypeScript/JavaScript | Provides core logic and orchestration for auth-response.interface.ts. | @modules |
| `jwt-payload.interface.ts` | TypeScript/JavaScript | Provides core logic and orchestration for jwt-payload.interface.ts. | N/A |
