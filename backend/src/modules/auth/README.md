...
## 🔗 Dependencies
- `./auth.controller`, `./auth.module`, `./auth.service`, `./dto/login.dto`, `./dto/register.dto`, `./infrastructure/jwt.strategy`, `./interfaces/auth-response.interface`, `./interfaces/jwt-payload.interface`, `./telegram-auth.service`, `@common/config/app-config.module`, `@common/config/app-config.service`, `@common/decorators/public.decorator`, `@modules/user`, `@nestjs/common`, `@nestjs/jwt`, `@nestjs/passport`, `bcrypt`, `crypto`
