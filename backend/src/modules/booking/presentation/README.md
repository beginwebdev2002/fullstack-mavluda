...
graph TD
  ...
  f_booking_controller_ts["📄 booking.controller.ts"]
  f_Root_presentation --> f_booking_controller_ts
  f_Dir_dto["📁 dto"]
...
|---|---|---|---|
| `booking.controller.ts` | TypeScript | Handles incoming HTTP requests and routing for booking.controller.ts. | @nestjs/common |
