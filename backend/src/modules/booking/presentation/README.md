...
*Breadcrumbs:* [backend](/backend) / [src](/backend/src) / [modules](/backend/src/modules) / [booking](/backend/src/modules/booking) / [presentation](/backend/src/modules/booking/presentation)
...
|---|---|---|---|
| `booking.controller.ts` | `ts` | Core functionality | `@nestjs/common` |
...
import { example } from './booking.controller.ts';
```
