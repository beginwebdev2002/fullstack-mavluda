...
|-----------|------|----------------|------------------|
| `create-booking.dto.ts` | DTO | Data Transfer Object for input validation. | None |
| `update-booking.dto.ts` | DTO | Data Transfer Object for input validation. | @nestjs/mapped-types |
