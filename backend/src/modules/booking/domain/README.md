...
[backend](../../../../README.md) > [src](../../../README.md) > [modules](../../README.md) > [booking](../README.md) > [domain](README.md)
...
graph TD
  subgraph domain
    booking_entity_ts["booking.entity.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `booking.entity.ts` | Source | Handles source logic for Mavluda Beauty's luxury standards. | `None` |
