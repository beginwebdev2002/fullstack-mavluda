...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [booking](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
graph TD
  subgraph schemas
    booking_schema_ts["booking.schema.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `booking.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
