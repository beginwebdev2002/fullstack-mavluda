...
*Breadcrumbs:* [backend](/backend) / [src](/backend/src) / [modules](/backend/src/modules) / [veil](/backend/src/modules/veil) / [application](/backend/src/modules/veil/application)
...
|---|---|---|---|
| `veil.service.ts` | `ts` | Core functionality | `@nestjs/common` |
