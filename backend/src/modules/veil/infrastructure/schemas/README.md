...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [veil](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
|-----------|------|----------------|------------------|
| `veil.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
