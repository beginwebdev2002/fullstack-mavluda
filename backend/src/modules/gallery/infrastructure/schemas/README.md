...
[backend](../../../../../README.md) > [src](../../../../README.md) > [modules](../../../README.md) > [gallery](../../README.md) > [infrastructure](../README.md) > [schemas](README.md)
...
graph TD
  subgraph schemas
    gallery_schema_ts["gallery.schema.ts"]
  end
```
...
|-----------|------|----------------|------------------|
| `gallery.schema.ts` | Schema | Handles schema logic for Mavluda Beauty's luxury standards. | `@nestjs` |
