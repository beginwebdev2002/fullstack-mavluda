...
graph TD
  ...
  f_Root_dto --> f_create_gallery_dto_ts
  f_update_gallery_dto_ts["📄 update-gallery.dto.ts"]
  f_Root_dto --> f_update_gallery_dto_ts
```
...
| `update-gallery.dto.ts` | TypeScript | Provides core logic and orchestration for update-gallery.dto.ts. | @nestjs/mapped-types |
