...
|---|---|---|---|
| `seed.module.ts` | TypeScript/JavaScript | Provides core logic and orchestration for seed.module.ts. | @common, @modules, @nestjs |
| `seed.service.ts` | TypeScript/JavaScript | Provides core logic and orchestration for seed.service.ts. | @common, @modules, @nestjs |
