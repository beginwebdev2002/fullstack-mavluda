[🏠 Home](../../../../../README.md) > [frontend](../../../../README.md) > [src](../../../README.md) > [entities](../../README.md) > [treatments](../README.md) > [constants](./README.md)
...
graph TD
  ...
  f_treatments_constants_ts["treatments.constants.ts"]
  Root_constants --> f_treatments_constants_ts
```

### 📄 FILE REGISTRY
| File Name | Type | Responsibility | Key Aliases Used |
|---|---|---|---|
| `treatments.constants.ts` | TypeScript File | Provides logic and definitions for treatments.constants.ts. | None |
