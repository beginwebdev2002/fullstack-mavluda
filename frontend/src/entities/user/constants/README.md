...
*Breadcrumbs:* [frontend](/frontend) / [src](/frontend/src) / [entities](/frontend/src/entities) / [user](/frontend/src/entities/user) / [constants](/frontend/src/entities/user/constants)
...
|---|---|---|---|
| `user.constants.ts` | `ts` | Core functionality | `None` |
...
import { example } from './user.constants.ts';
```
