...
@Component({
  ...
  template: `
    <aside
      class="h-full bg-sidebar-dark text-white flex flex-col w-64 border-r border-[#1F1F1F] shadow-2xl relative z-20"
    >
      <!-- Brand Header -->
      <div class="h-20 flex items-center px-6 border-b border-[#1F1F1F]">
        <div class="flex items-center gap-3">
          <!-- Icon -->
          <div
            class="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-display font-bold text-xl"
          >
            <span>M</span>
          </div>
          <!-- Text -->
          <div class="flex flex-col">
            <h2
              class="font-display text-lg font-bold text-white leading-tight tracking-wide"
              i18n="@@sidebarBrandName"
            >
              Mavluda
            </h2>
            <p
              class="text-[10px] uppercase text-primary tracking-widest font-medium mt-0.5"
              i18n="@@sidebarAdminConsole"
            >
              Admin Console
            </p>
          </div>
      ...
      <div class="p-4 border-t border-gray-800">
        <div
          class="flex items-center px-2 py-2 hover:bg-sidebar-active rounded-lg transition-colors cursor-pointer"
        >
          <div class="relative">
            <img
              class="w-10 h-10 rounded-full object-cover border border-gray-600"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDyPfY6aoO_pet0H3-Q7WlPTL0KsOFl31s_TD21ujHeq495bCH1erOCHAw7AnWtL9i70gf6gYTro4pCUQfDZRzxeVaig2jeIGz_FaK7NdbFaJaH4Mo141wcyWCVjI4nllnBIss796eaeGYiz3v95Jg_BEtL4X95x2vWPP6eqNBFcLEUdCHNLy_Yi_fb9qWDeF1Xgownfk9OmmLa2UVU5WTdbyXPSS6FJsC2HCHpDiaJ5O70cKqyw-Cs-Bgyhj5HWAEjcE25tm4IzY4o"
              alt="Admin User"
            />
            <span
              class="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 border-2 border-sidebar-dark rounded-full"
            ></span>
          </div>
          <div class="ml-3">
            <p class="text-sm font-medium text-white">Mavluda A.</p>
            <p class="text-xs text-gray-500" i18n="@@sidebarSuperAdmin">
              Super Admin
            </p>
          </div>
          <span
            class="material-symbols-outlined ml-auto text-gray-500 text-lg"
            i18n-title="@@sidebarLogout"
            title="Logout"
            >logout</span
          >
        </div>
