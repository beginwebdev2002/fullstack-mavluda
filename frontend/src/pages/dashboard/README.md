...
|---|---|---|---|
| `dashboard.component.html` | HTML | Structural template and layout for dashboard.component.html. | N/A |
| `dashboard.component.scss` | CSS/SCSS | Luxury styling and visual presentation for dashboard.component.scss. | N/A |
...
## 🔗 Dependencies
- `./dashboard.component`, `@angular/common`, `@angular/core`, `@entities/gallery/gallery.service`, `@entities/treatments/treatments.service`, `@entities/user/user.service`, `@entities/veil/veil.service`, `rxjs`
