...
| `veils-catalog.component.ts` | TypeScript/JavaScript | UI component logic and state management for veils-catalog.component.ts. | @angular, @entities, @environments, @shared |
