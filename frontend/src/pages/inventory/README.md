...
[Root](/../../../../README.md) / [frontend](../../../README.md) / [src](../../README.md) / [pages](../README.md) / [inventory](./README.md)
...
graph TD
  ...
  inventory --> inventory_component_html["🖼️ inventory.component.html"]
...
| `inventory.component.ts` | Component | UI component logic and state management for inventory.component.ts. | @angular |
