...
| `veil.component.scss` | CSS/SCSS | Luxury styling and visual presentation for veil.component.scss. | N/A |
...
## 🔗 Dependencies
- `./ui/veil-form/veil-form.component`, `./veil.component`, `@angular/common`, `@angular/core`, `@entities/admin-settings`, `@entities/veil`, `@environments/environment`, `@features/veil`, `@shared/lib`, `@shared/ui`, `rxjs`
