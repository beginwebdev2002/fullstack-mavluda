...
|---|---|---|---|
| `veil-form.component.html` | HTML | Handles logic and definitions for veil-form.component.html | None |
| `veil-form.component.ts` | TypeScript | Handles logic and definitions for veil-form.component.ts | @angular/common, @angular/forms/signals, @shared/lib |
