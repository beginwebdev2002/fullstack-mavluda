...
|---|---|---|---|
| `clients.component.html` | HTML | Structural template and layout for clients.component.html. | N/A |
...
## 🔗 Dependencies
- `./clients.component`, `@angular/common`, `@angular/core`, `@angular/forms`, `@entities/user`, `@features/client-form`, `@shared/ui`
