...
| `portfolio.component.scss` | CSS/SCSS | Luxury styling and visual presentation for portfolio.component.scss. | N/A |
...
## 🔗 Dependencies
- `./portfolio.component`, `@angular/common`, `@angular/core`, `@entities/admin-settings`, `@entities/gallery`, `@environments/environment`, `@shared/lib`
