...
| `treatments.component.scss` | CSS/SCSS | Luxury styling and visual presentation for treatments.component.scss. | N/A |
...
## 🔗 Dependencies
- `./components/treatment-form/treatment-form.component`, `./treatments.component`, `@angular/common`, `@angular/core`, `@angular/forms`, `@entities/admin-settings`, `@entities/treatments`, `@environments/environment`, `@features/treatments`, `@shared/lib`, `@shared/ui`
