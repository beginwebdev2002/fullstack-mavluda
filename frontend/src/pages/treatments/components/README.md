...
[frontend](../../../../README.md) > [src](../../../README.md) > [pages](../../README.md) > [treatments](../README.md) > [components](README.md)
...
```mermaid
graph TD
  componentsEmpty["Directory Structure Only"]
```
...
import { FeatureModule } from '@path/to/components';
```
