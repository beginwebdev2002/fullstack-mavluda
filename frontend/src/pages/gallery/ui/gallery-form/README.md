...
## 🔗 Dependencies
- `@angular/common`, `@angular/core`, `@angular/forms/signals`, `@environments/environment`, `@features/gallery`, `@shared/lib`, `@shared/models`, `@shared/ui`
