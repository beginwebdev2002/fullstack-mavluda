...
|---|---|---|---|
| `auth.service.ts` | TypeScript/JavaScript | Encapsulates business logic and data access for auth.service.ts. | @angular, @core, @shared |
| `error.service.ts` | TypeScript/JavaScript | Encapsulates business logic and data access for error.service.ts. | @angular |
| `image.service.ts` | TypeScript/JavaScript | Encapsulates business logic and data access for image.service.ts. | @angular |
| `index.ts` | TypeScript/JavaScript | Provides core logic and orchestration for index.ts. | N/A |
| `telegram.service.ts` | TypeScript/JavaScript | Encapsulates business logic and data access for telegram.service.ts. | @angular, @src |
