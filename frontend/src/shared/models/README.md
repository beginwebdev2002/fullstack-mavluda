...
|---|---|---|---|
| `admin-settings.model.ts` | TypeScript/JavaScript | Provides core logic and orchestration for admin-settings.model.ts. | N/A |
| `api-response.model.ts` | TypeScript/JavaScript | Provides core logic and orchestration for api-response.model.ts. | N/A |
| `gallery.model.ts` | TypeScript/JavaScript | Provides core logic and orchestration for gallery.model.ts. | N/A |
| `index.ts` | TypeScript/JavaScript | Provides core logic and orchestration for index.ts. | N/A |
| `service.model.ts` | TypeScript/JavaScript | Encapsulates business logic and data access for service.model.ts. | N/A |
