...
const gallery_controller_1 = require("./presentation/gallery.controller");
const gallery_repository_1 = require("./infrastructure/repositories/gallery.repository");
const gallery_schema_1 = require("./infrastructure/schemas/gallery.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: gallery_schema_1.GallerySchemaEntity.name, schema: gallery_schema_1.GallerySchema },
            ]),
        ],
        controllers: [gallery_controller_1.GalleryController],
        providers: [gallery_service_1.GalleryService, gallery_repository_1.GalleryRepository],
