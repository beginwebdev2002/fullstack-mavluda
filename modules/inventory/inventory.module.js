...
const inventory_schema_1 = require("./infrastructure/schemas/inventory.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: inventory_schema_1.InventorySchemaEntity.name, schema: inventory_schema_1.InventorySchema },
            ]),
        ],
